<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="价格(钻石)">
        <template slot-scope="scope">{{ scope.row.price }}</template>
      </el-table-column>
      <el-table-column align="center" label="累积点赞数">
        <template slot-scope="scope">{{ scope.row.giveNum }}</template>
      </el-table-column>
      <el-table-column align="center" label="累积转发数">
        <template slot-scope="scope">{{ scope.row.forwardNum }}</template>
      </el-table-column>
      <el-table-column align="center" label="累积浏览数">
        <template slot-scope="scope">{{ scope.row.browseNum }}</template>
      </el-table-column>
      <el-table-column align="center" label="累积获取礼物总数">
        <template slot-scope="scope">{{ scope.row.giftNum }}</template>
      </el-table-column>
      <el-table-column align="center" label="累积获取数量总价">
