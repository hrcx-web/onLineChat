        ...
        <el-row :gutter="10">
          <el-col :span="20">
            <el-form-item label="抽成比例">
              <el-input v-model="AsForm.profit" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import { query, updateUser, userDelete, uploadQNImg, queryLabelInUse, getUserAuthInfo, bindCustomer, usergetMap, getById, addOrEdit, authUserInfo, warnLogAdd, userQueryById, editProfit, uploadSource } from '@/api/user'
