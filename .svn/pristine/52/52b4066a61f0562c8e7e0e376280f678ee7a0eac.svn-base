<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :show-overflow-tooltip="true" label="描述">
...
export default {
  ...
  methods: {
    ...
    showDialog(mode, item) {
      ...
      if (mode === 'edit') {
        this.form = copyObject(this.form, item, {
          numberToString: true })
        // this.form.value = this.form.value.split(',')
      }
    ...
    updateSubmit() {
      ...
      // if (Array.isArray(_form.value)) {
      //   _form.value = _form.value.join(',')
      // }
    ...
    deleteFileOrDirectory() {
      ...
      this.$confirm('确定要删除选中的标签信息吗?', '提示').then(() => {
        deleteBatch({
          ids: ids
        }).then(data => {
